                    ...
                    <div class="tab-content" id="custom-tabs-three-tabContent">
                        <div class="tab-pane fade active show" id="masuk" role="tabpanel" aria-labelledby="masuk-tab">
                            @foreach ($bookings->where('status', 'Menunggu Konfirmasi') as $booking)
                                <a href="{{ route('booking.show', $booking->id) }}" class="card bg-warning py-3 px-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 pt-3 border-top text-right">{{ $booking->status }}</div>
                                    </div>
                                </a>
                            @endforeach
                        </div>
                        <div class="tab-pane fade" id="ongoing" role="tabpanel" aria-labelledby="ongoing-tab">
                            @foreach ($bookings->where('status', 'Diproses') as $booking)
                                <a href="{{ route('booking.show', $booking->id) }}" class="card bg-primary py-3 px-4">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <p>{{ $booking->name }}</p>
                                            <h3>{{ $booking->Package->name }}</h3>
                        ...
                        <div class="tab-pane fade" id="selesai" role="tabpanel" aria-labelledby="selesai-tab">
                            @foreach ($bookings->where('status', 'Selesai') as $booking)
                                <a href="{{ route('booking.show', $booking->id) }}" class="card bg-success py-3 px-4">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <p>{{ $booking->name }}</p>
                                            <h3>{{ $booking->Package->name }}</h3>
                        ...
                        <div class="tab-pane fade" id="batal" role="tabpanel" aria-labelledby="batal-tab">
                            @foreach ($bookings->where('status', 'Dibatalkan') as $booking)
                                <a href="{{ route('booking.show', $booking->id) }}" class="card bg-danger py-3 px-4">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <p>{{ $booking->name }}</p>
                                            <h3>{{ $booking->Package->name }}</h3>

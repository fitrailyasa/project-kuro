    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            @if (auth()->user()->role == 'admin')
                <form method="POST" action="{{ route('admin.package_p.update', $package->id) }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea 
                                class="form-control mb-1 @error('list') is-invalid @enderror" 
                                placeholder="List" 
                                name="list" 
                                id="list"
                                rows="4">{{ is_array($package->list) ? implode(', ', $package->list) : '' }}</textarea>
                            @error('list')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror

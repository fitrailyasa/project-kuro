...
<aside class="main-sidebar elevation-4 bg-dark">
    ...
    <a href="#" class="brand-link">
        <img src="{{ asset('assets/img/logo2.png') }}" alt="Logo" class="brand-image img-circle elevation-3"
            style="opacity: .8">
        <span class="brand-text font-weight-normal text-white">PROJECT KURO</span>
    </a>
